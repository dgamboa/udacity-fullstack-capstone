...
# Method that retrieves the token from the request header
# First input method into the requires_auth authentication method
...
# Method that verifies the permissions of the user with the token
# Third input method into the requires_auth authentication method
